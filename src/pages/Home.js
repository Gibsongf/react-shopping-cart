...
export const Home = () => {
	...
	return (
		<div className="home-content">
			...
			<div className="about">
				<p> <strong>Dead Cells</strong>  is a rogue-like, Castlevania-inspired
				action-platformer from Motion Twin.
				It was released on the 7th of August 2018.</p>
				<br /> 
				<p> It will allow you to explore a sprawling,
				...
				<br />
				<p>
				<strong>RogueVania</strong>: The progressive exploration of an interconnected world, with the
				replayability of a rogue-like and the adrenaline pumping threat
				of permadeath. 
				</p>
				<br />
				<p>
				<strong>2D Souls-like Action</strong>: Tough but fair combat, more
